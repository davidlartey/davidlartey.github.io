...
function Article({ article }) {
  return (
    <Card as="article">
      ...
      <Card.Cta>Read thought</Card.Cta>
    </Card>
  )
}
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          David Lartey - Beauty savourer, software engineer, social entrepreneur, songwriter and amateur nature photographer
        </title>
        <meta
          name="description"
          content="My name is David, a software engineer and a social entrepreneur based in Accra, Ghana. I’m the founder and CEO of Near For Good, where we craft technologies that bring out the full potential of people in the developing world."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://instagram.com/Dbilovd"
